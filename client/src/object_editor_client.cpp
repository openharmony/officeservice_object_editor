...
std::string ObjectEditorClient::GenRandomUuid()
{
    ...
    const int INDEX_1 = 1;
    const int INDEX_0 = 0;
    const int RIGHT_SHIFT_8 = 8;
    const int RIGHT_SHIFT_16 = 16;
    const int RIGHT_SHIFT_24 = 24;
    const int RIGHT_SHIFT_32 = 32;
    const int RIGHT_SHIFT_40 = 40;
    const int RIGHT_SHIFT_48 = 48;
    const int RIGHT_SHIFT_56 = 56;
