...
#ifndef OHOS_OBJECT_EDITOR_OBJECT_EDITOR_PACKAGE_STUB_H
#define OHOS_OBJECT_EDITOR_OBJECT_EDITOR_PACKAGE_STUB_H
...
class ObjectEditorPackageStub : public IRemoteStub<IObjectEditorPackage> {
public:
    explicit ObjectEditorPackageStub(bool serialInvokeFlag = false) : IRemoteStub(serialInvokeFlag){};
...
#endif // OHOS_OBJECT_EDITOR_OBJECT_EDITOR_PACKAGE_STUB_H
