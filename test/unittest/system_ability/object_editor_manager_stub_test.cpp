...
ErrCode MockObjectEditorManagerStub::GetHmidByFileExtension(
    const std::string &hmid,
    std::string &fileExtension)
{
    OBJECT_EDITOR_LOGI(ObjectEditorDomain::SA, "hmid: %{public}s", hmid.c_str());
    return error;
}

ErrCode MockObjectEditorManagerStub::GetIconByHmid(
    const std::string &hmid,
...
{
    OBJECT_EDITOR_LOGI(ObjectEditorDomain::SA, "hmid: %{public}s, locale: %{public}s", hmid.c_str(), locale.c_str());
    return error;
}

ErrCode MockObjectEditorManagerStub::GetObjectEditorFormatByHmidAndLocale(
    const std::string &hmid,
    const std::string &locale,
...
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_HMID_BY_FILE_EXTENSION);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleStartObjectEditorExtension_write_oeExtensionRemoteObject_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_START_OBJECT_EDITOR_EXTENSION);
    MessageParcel data;
    MessageParcel reply;
...
/**
 * @tc.name: HandleGetHmidByFileExtension_write_errCode_failed
 * @tc.desc: Test HandleGetHmidByFileExtension for write errCode failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetHmidByFileExtension_write_errCode_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_HMID_BY_FILE_EXTENSION);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetHmidByFileExtension_write_errCode_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    MockMessageParcel::SetWriteInt32ErrorFlag(true);
    int32_t ret = stub_->OnRemoteRequestInner(code, data, reply, option);
    EXPECT_EQ(ret, ERR_INVALID_VALUE);
    EXPECT_TRUE(logMsg.find("write errCode failed") != std::string::npos);
...
/**
 * @tc.name: HandleGetHmidByFileExtension_errCode_failed
 * @tc.desc: Test HandleGetHmidByFileExtension for errCode failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetHmidByFileExtension_errCode_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_HMID_BY_FILE_EXTENSION);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetHmidByFileExtension_errCode_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    stub_->error = ERR_INVALID_VALUE;
...
/**
 * @tc.name: HandleGetHmidByFileExtension_write_fileExtension_failed
 * @tc.desc: Test HandleGetHmidByFileExtension for write fileExtension failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetHmidByFileExtension_write_fileExtension_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_HMID_BY_FILE_EXTENSION);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetHmidByFileExtension_write_fileExtension_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
...
/**
 * @tc.name: HandleGetHmidByFileExtension_success
 * @tc.desc: Test HandleGetHmidByFileExtension for success case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetHmidByFileExtension_success, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_HMID_BY_FILE_EXTENSION);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetHmidByFileExtension_success";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    int32_t ret = stub_->OnRemoteRequestInner(code, data, reply, option);
...
/**
 * @tc.name: HandleGetIconByHmid_write_errCode_failed
 * @tc.desc: Test HandleGetIconByHmid for write errCode failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetIconByHmid_write_errCode_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_ICON_BY_HMID);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetIconByHmid_write_errCode_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    MockMessageParcel::SetWriteInt32ErrorFlag(true);
...
/**
 * @tc.name: HandleGetIconByHmid_errCode_failed
 * @tc.desc: Test HandleGetIconByHmid for errCode failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetIconByHmid_errCode_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_ICON_BY_HMID);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetIconByHmid_errCode_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    stub_->error = ERR_INVALID_VALUE;
...
/**
 * @tc.name: HandleGetIconByHmid_write_resourceId_failed
 * @tc.desc: Test HandleGetIconByHmid for write resourceId failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetIconByHmid_write_resourceId_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_ICON_BY_HMID);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetIconByHmid_write_resourceId_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    MockMessageParcel::SetWriteString16ErrorFlag(true);
...
/**
 * @tc.name: HandleGetIconByHmid_success
 * @tc.desc: Test HandleGetIconByHmid for success case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetIconByHmid_success, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_ICON_BY_HMID);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetIconByHmid_success";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    int32_t ret = stub_->OnRemoteRequestInner(code, data, reply, option);
...
/**
 * @tc.name: HandleGetObjectEditorFormatByHmidAndLocale_write_errCode_failed
 * @tc.desc: Test HandleGetObjectEditorFormatByHmidAndLocale for write errCode failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetObjectEditorFormatByHmidAndLocale_write_errCode_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_FORMAT_BY_HMID_AND_LOCALE);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetObjectEditorFormatByHmidAndLocale_write_errCode_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
...
/**
 * @tc.name: HandleGetObjectEditorFormatByHmidAndLocale_errCode_failed
 * @tc.desc: Test HandleGetObjectEditorFormatByHmidAndLocale for errCode failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetObjectEditorFormatByHmidAndLocale_errCode_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_FORMAT_BY_HMID_AND_LOCALE);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetObjectEditorFormatByHmidAndLocale_errCode_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    data.WriteString16(Str8ToStr16("test_locale"));
...
/**
 * @tc.name: HandleGetObjectEditorFormatByHmidAndLocale_format_null
 * @tc.desc: Test HandleGetObjectEditorFormatByHmidAndLocale for format null case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetObjectEditorFormatByHmidAndLocale_format_null, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_FORMAT_BY_HMID_AND_LOCALE);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetObjectEditorFormatByHmidAndLocale_format_null";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    data.WriteString16(Str8ToStr16("test_locale"));
...
/**
 * @tc.name: HandleGetObjectEditorFormatByHmidAndLocale_write_format_failed
 * @tc.desc: Test HandleGetObjectEditorFormatByHmidAndLocale for write format failed case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetObjectEditorFormatByHmidAndLocale_write_format_failed, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_FORMAT_BY_HMID_AND_LOCALE);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetObjectEditorFormatByHmidAndLocale_write_format_failed";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    data.WriteString16(Str8ToStr16("test_locale"));
...
/**
 * @tc.name: HandleGetObjectEditorFormatByHmidAndLocale_success
 * @tc.desc: Test HandleGetObjectEditorFormatByHmidAndLocale for success case
 * @tc.type: FUNC
 */
HWTEST_F(ObjectEditorManagerStubTest, HandleGetObjectEditorFormatByHmidAndLocale_success, TestSize.Level1)
{
    uint32_t code = static_cast<uint32_t>(IObjectEditorManagerIpcCode::COMMAND_GET_FORMAT_BY_HMID_AND_LOCALE);
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;;
    stub_->testcaseName = "HandleGetObjectEditorFormatByHmidAndLocale_success";
    std::u16string descriptor = stub_->GetDescriptor();
    data.WriteInterfaceToken(descriptor);
    data.WriteString16(Str8ToStr16("test_hmid"));
    data.WriteString16(Str8ToStr16("test_locale"));
