...
public:
    ...
    static void SetReadRemoteObjectErrorFlag(bool flag);
    ...
    static void SetWriteStringErrorCount(int32_t count);
    static void SetReadStringErrorCount(int32_t count);
    static void SetReadString16ErrorFlag(bool flag);
    static void SetWriteRemoteObjectErrorCount(int32_t count);
};
}
}  // namespace OHOS
#endif